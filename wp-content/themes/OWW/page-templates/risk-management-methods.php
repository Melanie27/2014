			...
			<section class="three container">
				<div class="row">
					<section class="col-lg-12 col-md-12  col-sm-12 col-xs-12">
						<h2>A Greater Standard of Reliability</h2>
						<h3>Proactive preparedness that allows our clients to focus on business</h3>	
			...
			<section class="five container">
				<div class="row">
					<section class="col-lg-12 col-md-12 ">
						<h2>Corporate Integrity and Associate Professionalism</h2>
			...
			<section class="eleven container">
				<div class="row">
					<section class="col-lg-12 col-md-12 ">
						...
						<p>In the event of a security threat, natural disaster or other unpredictable emergency, Oakwood Worldwide has a global crisis management program in place to protect our guests. Developed in accordance with the best practices of Fortune 500 companies, the program includes trained crisis teams, with designated leaders, coordinators and support resources, in place at local, regional and global levels. This crisis management plan is regularly reviewed by associates and drills and simulations are conducted annually. We’ve also integrated the Everbridge emergency notification system into our crisis management program, allowing us to communicate with affected guests within a timely manner using multiple channels, including voice, text and email.</p>
					</section>
				</div>
			</section><!--eleven-->
			<hr />	
