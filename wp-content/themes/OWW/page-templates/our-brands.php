						...
						<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="row">
								<section class="col-lg-4 col-md-4 intro oakwood">
									<div class="row">
										<section class="col-lg-12 col-md-12 col-xs-6 logo">
											<img src="<?php bloginfo( 'template_directory' ); ?>/images/sitewide/logo-oakwood-lg.jpg" alt="Oakwood" class="img-responsive">
										</section>
								...
								<section class="col-lg-4 col-md-4 intro execustay ">
									<div class="row">
										<section class="col-lg-12 col-md-12 col-xs-6 logo">
											<img src="<?php bloginfo( 'template_directory' ); ?>/images/sitewide/logo-execustay-lg.jpg" alt="Execustay" class="img-responsive">
										</section>
										<div class="clearfix"></div>
										<section class="col-lg-12 col-md-12">
