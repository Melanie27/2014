										...
										<ul class="col-lg-12">
											...
											<li class="col-lg-4 col-md-4 hidden-sm hidden-xs">
												<?php the_post_thumbnail('herosize'); ?>
													...
													<p class="headline size-12" style="font-size:12px;"><a href="<?php the_permalink(); ?>"><?php echo esc_html( get_post_meta( get_the_ID(), 'press_release_title', true ) ); ?><?php the_title(); ?> </p></a>
											</li>
