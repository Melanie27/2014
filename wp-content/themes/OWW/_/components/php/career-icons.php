									<div class="row">
										<section class="col-lg-3 col-md-3 col-sm-12 col-xs-12 career-icons center-block">
											...
											<h3 class="icon-heading">Career Development Opportunities</h3>
										...
										<section class="col-lg-3 col-md-3 col-sm-12 col-xs-12 career-icons center-block">
											<div class="row">
												...
												<section class="col-lg-12 col-md-12 col-sm-8 col-xs-8">
													<h3 class="icon-heading">Dynamic Work Environment</h3>
													<ul class="career-bullets">
										...
										<section class="col-lg-3 col-md-3 col-sm-12 col-xs-12 career-icons center-block">
											<div class="row">
												...
												<section class="col-lg-12 col-md-12 col-sm-8 col-xs-8">
													<h3 class="icon-heading">Generous Benefits</h3>
													<ul class="career-bullets">
										...
										<section class="col-lg-3 col-md-3 col-sm-12 col-xs-12 career-icons center-block">
											<div class="row">
												...
												<section class="col-lg-12 col-md-12 col-sm-8 col-xs-8">
													<h3 class="icon-heading">Recognition & Awards</h3>
													<ul class="career-bullets">
